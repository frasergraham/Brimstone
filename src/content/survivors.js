...
export const SURVIVOR_ROSTER = [
  ...
  },
  {
    ...
    maxHp: 35, attack: 1, defense: 3,
    ability: SurvivorAbility.HEAL,
    abilityLabel: 'Tend Wounds — heals the hero 7 HP (costs 1 action)',
  },
  {
    name: 'Thomas Putnam',
    title: 'Blacksmith',
  ...
  },
  {
    ...
    maxHp: 49, attack: 1, defense: 3,
    ability: SurvivorAbility.HEAL,
    abilityLabel: 'Tender Care — heals the hero 7 HP (costs 1 action)',
  },
  {
    name: 'Silas Holt',
    title: 'Farmhand',
  ...
  },
  {
    ...
    maxHp: 28, attack: 1, defense: 3,
    ability: SurvivorAbility.HEAL,
    abilityLabel: 'Salve and Poultice — heals the hero 7 HP (costs 1 action)',
  },
  {
    name: 'Caleb Osgood',
    title: 'Fisherman',
