...
export function createElementsBag(overrides = {}) {
  const ids = [
    'zoom-in','zoom-out','zoom-fit','zoom-me','replay-detail-btn','canvas-wrapper',
    ...
    'chronicle-close','chronicle-overlay',
    'chronicle-sidebar','chronicle-sidebar-log','chronicle-tab','chronicle-tab-toggle','event-log',
